...
describe("Prototype Attribute", function () {
  ...
  it("Expected output of new Teacher().teach('WAP') is 'Prof. Keith Levi is now teaching WAP'", function () {
    assert.equal(me.teach("WAP"), 'Prof. Keith Levi is now teaching WAP')
  });
});
